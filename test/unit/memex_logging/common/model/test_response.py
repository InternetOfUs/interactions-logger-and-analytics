...
class TestAnalyticResponse(TestCase):
    ...
    def test_repr(self):
        response = AnalyticResponse(UserAnalytic(MovingTimeWindow("7D"), "project", "u:total"), AnalyticResult(1, ["1"], "userId"), "static_id")
...
class TestAggregationResponse(TestCase):
    ...
    def test_repr(self):
        response = AggregationResponse(AggregationAnalytic(MovingTimeWindow("7D"), "project", "intent.confidence", "avg", None), 0.78, "static_id")
